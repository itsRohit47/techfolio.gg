        ...
        <div className="max-h-screen h-full mx-auto relative">
            ...
            {!preview && session.data?.user?.id === u_id && (
                <div className="flex fixed z-50 top-4 right-4 gap-2">
                    <Link href={`/dashboard/design`} passHref className="bg-white text-black px-2 py-1 rounded-md shadow-md">
                        Edit design
                    </Link>
                    <Link href={`/dashboard/build`} passHref className="bg-white text-black px-2 py-1 rounded-md shadow-md">
                        Edit content
                    </Link>
                </div>
            )}
